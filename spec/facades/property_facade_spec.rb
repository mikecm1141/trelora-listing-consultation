...
describe PropertyFacade do
  ...
  it 'exists with standard attributes' do
    ...
    expect(subject.zillow_zestimate_high).to eq(754000)
    expect(subject.zillow_zestimate_low).to eq(696000)
    expect(subject.zillow_zestimate).to eq(704000)
    expect(subject.home_junction_low).to eq(578000)
    expect(subject.home_junction_high).to eq(679000)
    expect(subject.home_junction_regional_average).to eq(689000)
